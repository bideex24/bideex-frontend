...
import {
  toysGamesMenuItems,
  collectiblesAntiquesMenuItems,
  sportsEquipmentMenuItems,
  outdoorGearCampingMenuItems,
  musicalInstrumentsMenuItems,
  kidsClothesAccessoriesMenuItems,
} from "./subMenu/Sports";
import {
  furnitureMenuItems,
  homeAppliancesMenuItems,
  kitchenwareMenuItems,
  homeDecorMenuItems,
  lightingFixturesMenuItems,
  toolsEquipmentMenuItems,
} from "./subMenu/Living";
import {
  mobileMenuItems,
...
import {
  ...
  partsMenuItems,
  boatsMenuItems,
} from "./subMenu/Vehicles";
import {
  womensClothingMenuItems,
  footWearMenuItems,
  bagsMenuItems,
  haircareMenuItems,
  jewelryaccessoriesMenuItems,
  makeupMenuItems,
} from "./subMenu/Womens";
import {
  dogsPuppiesMenuItems,
  catsKittensMenuItems,
  birdsMenuItems,
  fishAquariumsMenuItems,
  petFoodAccessoriesMenuItems,
  otherPetsMenuItems,
} from "./subMenu/Animals";
import {
  booksStudyMaterialsMenuItems,
  onlineCoursesCertificationsMenuItems,
  schoolSuppliesMenuItems,
  educationalToysMenuItems,
} from "./subMenu/Education";
import {
  groceriesFoodItemsMenuItems,
  personalHygieneProductsMenuItems,
  cleaningSuppliesMenuItems,
} from "./subMenu/Essentials";
import {
  mensClothingMenuItems,
  mensFootWearMenuItems,
  bagsLuggageMenuItems,
  watchesaccessoriesMenuItems,
  groomingMenuItems,
  sunglassesbeltsMenuItems,
} from "./subMenu/Mens";
import {
  apartmentsforSaleMenuItems,
  apartmentsforRentMenuItems,
  landforSaleMenuItems,
  commercialPropertyforRentMenuItems,
  roomRentalSharedHousingMenuItems,
} from "./subMenu/Property";
import {
  industrialMachineryMenuItems,
  officeSuppliesMenuItems,
  constructionEquipmentMenuItems,
  toolsHardwareMenuItems,
  printingPackagingSuppliesMenuItems,
  safetySecurityEquipmentMenuItems,
} from "./subMenu/Business";
import {
  farmingMenuItems,
  plantsMenuItems,
  stockMenuItems,
} from "./subMenu/Agriculture";
import {
  freelanceServicesMenuItems,
  homeServicesMenuItems,
} from "./subMenu/Services";
    ...
    <div className="lg:relative">
      ...
      <div className="flex">
        ...
        <nav className={`nav ${isNavOpen ? "nav-open" : "nav-closed"}`}>
          <ul className="font-medium text-black">
            <li>
              <Link className="links hover:font-semibold" to="/">
                Home
              </Link>
              <hr />
            </li>
            ...
            <li>
              <section className="flex items-center justify-between cursor-pointer hover:font-bold">
                <button
                  className="links hover:font-semibold"
                  onClick={() => setSubOpen(!isSubOpen)}
                >
                  {isSubOpen ? (
                    <li
                      className="flex items-center justify-between bg-slate-200
          "
                      id="categories"
                    >
                      <span>
                ...
                <SubMenuOne isSubOpen={isSubOpen}></SubMenuOne>
              </section>
              <hr />
            </li>
            <li>
      ...
      <div className="small-display max-w-6xl mx-auto lg:block">
        <ul className="menu menu-horizontal py-0 text-sm">
          ...
          <li>
            <button className="py-4">
              <Link className="font-bold main-menu" to="">
                View All Ads
              </Link>
            </button>
          </li>
          ...
          <li>
            ...
            <ul className="dropdown1 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 mt-12  pb-10 text-black">
              ...
              <li>
                <Link className="hover:font-bold" to="/categories/mobiles">
                  Hobbies Sports and Kids
                  <span>
                    <FaCaretRight />
                  </span>
                </Link>
                <ul className="dropdown2 ml-52 shadow-lg bg-white rounded w-72 mt-3 py-2">
                  ...
                  <li>
                    <Link
                      ...
                      to="/categories/mobiles/mobile-phone"
                    >
                      Toys and Games
                      <span>
                        <FaCaretRight />
                    ...
                    <ul className="dropdown3 ml-40 shadow-lg bg-white rounded w-52 py-2">
                      ...
                      {toysGamesMenuItems.map((item) => (
                        <li key={item.path}>
                          <Link className="hover:font-bold" to={item.path}>
                            {item.label}
                          </Link>
                        </li>
                      ))}
                  ...
                  <li>
                    <Link
                      className="hover:font-bold"
                      to="/categories/mobiles/mobile-phone/moble-phone-accessories"
                    >
              ...
              <li>
                ...
                <ul className="dropdown2 ml-32 shadow-lg bg-white rounded w-80 mt-3 py-2">
                  ...
                  <li>
                    <Link
                      className="hover:font-bold"
                      to="/categories/electronics/desktop-computer"
                    >
                      Desktop Computers
                      <span>
                        <FaCaretRight />
                  ...
                  <li>
                    <Link
                      className="hover:font-bold"
                      to="/categories/electronics/tv-monitors"
                    >
                      TVs and Monitors
                      <span>
                        <FaCaretRight />
                  ...
                  <li>
                    <Link
                      className="hover:font-bold"
                      to="/categories/electronics/cameras-accessories"
                    >
                  ...
                  <li>
                    <Link
                      className="hover:font-bold"
                      to="/categories/electronics/audio-sound-systems"
                    >
                  ...
                  <li>
                    <Link
                      className="hover:font-bold"
                      to="/categories/electronics/gaming-consoles-accessories"
                    >
                  ...
                  <li>
                    <Link
                      className="hover:font-bold"
                      to="/categories/electronics/smart-home-devices"
                    >
                      Smart Home Devices
                      <span>
                        <FaCaretRight />
